    ...
    var increaseQuantity = function(lineItemId){
        $.ajax({
            ...
            success: function(data){
                ...
                document.getElementById("lineitem-quantity").innerHTML = "Quantity: " + obj.quantity;
                document.getElementById("lineitem-price").innerHTML = obj.price + " " + obj.currency;
                document.getElementById("totalprice").innerHTML = "Total Price: " + obj.totalprice + " " + obj.currency;
            },
            error: function(data){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (obj.status === "exists") {
                    document.getElementById("lineitem-quantity").innerHTML = "Quantity: " + obj.quantity;
                    document.getElementById("lineitem-price").innerHTML = obj.price + " " + obj.currency;
                    document.getElementById("totalprice").innerHTML = "Total Price: " + obj.totalprice + " USD";
                }
